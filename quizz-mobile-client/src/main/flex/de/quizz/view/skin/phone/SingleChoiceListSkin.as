...
{
	import de.quizz.view.util.SingleChoiceListView;
	...
	public class SingleChoiceListSkin extends MobileSkin
	{
		//----------------------
		// HostComponent
		//----------------------
		 ...
		 */
		public var hostComponent:SingleChoiceListView;
		...
		public function SingleChoiceListSkin()
		{
			super();
